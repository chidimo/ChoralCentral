# Generated by Django 2.2.2 on 2019-08-26 01:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('media_file', models.FileField(upload_to=song_media.utils.save_score)),
                ...
                ('notation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='song_media.ScoreNotation')),
                ('part', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='song_media.VocalPart')),
                ('song', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='song.Song')),
            ],
            options={
