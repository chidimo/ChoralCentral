...
1. Implement readerview (reportlab)
...
1. Suggest names to user based on similarity with already present names.
1. Create it if they're sure its not the same person.
...
1. Fix groups
1. Implement stackoverflow-like suggestion when creating new song or author
