    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator(code='Not set', message='Only alphanumeric values are allowed.', regex='[a-zA-Z0-9-\\s]+')])),
                ('last_name', models.CharField(max_length=30, validators=[django.core.validators.RegexValidator(code='Not set', message='Only alphanumeric values are allowed.', regex='[a-zA-Z0-9-\\s]+')])),
