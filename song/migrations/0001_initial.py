    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', universal.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', universal.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('part', models.CharField(choices=[('', 'Select an option'), ('entrance', 'Entrance'), ('kyrie', 'Kyrie'), ('gloria', 'Gloria'), ('acclamation', 'Acclamation'), ('offertory', 'Offertory'), ('communion', 'Communion'), ('sanctus', 'Sanctus'), ('agnus dei', 'Agnus Dei'), ('recesssion', 'Recesssion'), ('na', 'NA')], max_length=15, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', universal.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', universal.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('season', models.CharField(choices=[('', 'Select an option'), ('ordinary time', 'Ordinary Time'), ('advent', 'Advent'), ('christmas', 'Christmas'), ('lent', 'Lent'), ('Easter', 'Easter'), ('pentecost', 'Pentecost'), ('na', 'NA')], max_length=15, unique=True)),
                ('about', models.TextField()),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ocassion', models.CharField(choices=[('sacred', 'Sacred/Liturgical'), ('secular', 'Secular'), ('na', 'na')], default='sacred', max_length=30)),
                ('genre', models.CharField(choices=[('', 'Select an option'), ('hymn', 'Hymn'), ('psalm', 'Psalm'), ('gregorian chant', 'Gregorian Chant'), ('sequence', 'Sequence'), ('chorus', 'Chorus'), ('carol', 'Carol'), ('requiem', 'Requiem'), ('mass', 'Mass'), ('anthem', 'Anthem'), ('popular music', 'Popular music'), ('folk music', 'Folk music')], default='hymn', max_length=30)),
