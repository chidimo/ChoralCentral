    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1000), django.core.validators.MaxValueValidator(2019)])),
                ...
                ('voicing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='song.Voicing')),
            ],
            options={
