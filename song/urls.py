...
urlpatterns = [
    ...
    path("season/<str:season>/", views.FilterBySeason.as_view(), name="filter_season"),
    path("masspart/<str:masspart>/", views.FilterByMasspart.as_view(), name="filter_masspart"),
    path("<int:pk>/<slug:slug>/author-songs/", views.FilterByAuthor.as_view(), name="filter_author"),
