"""
Django settings for somto project.
...
if ENV_ROLE == "development":
    DEBUG = True
    SOMTO_PASS = get_env_variable('SOMTO_PASS')
...
WSGI_APPLICATION = 'somto.wsgi.application'
...
if deployment_platform == "localsqlite3":
    ...
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'somto.sqlite3'),
        }
    }
    ...
    'default': {
        ...
        'NAME': 'sohtire$somto',
        'USER': 'sohtire',
        'PASSWORD': get_env_variable('SOMTO_PASS'),
